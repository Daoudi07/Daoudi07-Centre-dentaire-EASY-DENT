...
const DOCTORS = [
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/savigny-sur-orge/sandy-barbosa?pid=practice-131168",
  },
  {
  ...
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/port-de-bouc/loana-saggesi?pid=practice-131168",
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/port-de-bouc/emilie-egidio-port-de-bouc?pid=practice-131168",
  },
  {
  ...
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/port-de-bouc/ophelie-rogeon-fbc1f39f-d022-4237-936b-d92f20f398c1?pid=practice-131168",
  },
];

const REVIEWS = [
  {
    text: "Cabinet au top! Le meilleur que j'ai fait dans ma vie! Que ce soit niveau soin dentaire, sans parler de la décoration du cabinet, l'hygiène vraiment au top!",
    author: "Patient vérifié",
  },
  {
    text: "Nous sommes extrêmement satisfaits de ce cabinet dentaire, tant par l'accueil, le professionnalisme et la gentillesse du personnel ainsi que l'hygiène qui est irréprochable.",
    author: "Sophie M.",
  },
  {
    text: "Un cabinet super classe, un accueil irréprochable par une équipe efficace et plutôt rare chez un dentiste jamais d'attente! Le directeur et les dentistes rapides, efficaces.",
    author: "Thomas B.",
  },
  {
  ...
  {
    text: "Le docteur Margheriti m'a fait de superbes couronnes fidèle à sa réputation. Le centre est très propre et ils ont fait tous les papiers administratifs.",
    author: "Jean-Pierre D.",
  },
  {
    text: "Cabinet dentaire au top!! Des secrétaires adorables sans parler du Dr Margheriti, enfin un chirurgien gentil et compétent à la fois. Merci à vous.",
    author: "Caroline R.",
  },
  {
    text: "J'ai eu la belle surprise de voir que le tiers payant est réalisé pour tutte les mutuelles. Un vrai plus. Centre moderne et accueillant, je recommande!",
    author: "Ahmed K.",
  },
];
    ...
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
        ...
        <div className="container relative z-10 px-4 pt-20 flex flex-col items-center text-center">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/20 backdrop-blur-md border border-accent/30 text-accent mb-8"
            >
              <Star className="w-4 h-4 fill-current" />
              <span className="text-sm font-bold uppercase tracking-wider">
                L'excellence dentaire à Port-de-Bouc
              </span>
            </motion.div>

            <motion.h1
              variants={fadeIn}
              className="text-[2rem] md:text-[4rem] font-display font-black leading-[1.1] mb-6 text-white text-shadow-lg whitespace-normal break-keep"
            >
              Votre Centre Dentaire <br className="hidden md:block" />
              <span className="text-accent">de Référence</span>{" "}
              <br className="hidden md:block" />à Port-de-Bouc
            </motion.h1>

            <motion.p
              variants={fadeIn}
              className="text-lg md:text-2xl text-white font-bold mb-10 max-w-2xl mx-auto leading-relaxed text-shadow-lg"
            >
              L'excellence médicale au service de votre sourire. Un plateau
              technique de pointe dans un cadre d'exception.
            </motion.p>
          ...
          <div className="mt-8 md:mt-[60px] flex flex-col md:grid md:grid-cols-3 gap-4 md:gap-6 w-full max-w-5xl px-4 md:px-0">
            {[
              {
                icon: () => (
                  <div className="w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-red-500 shadow-[0_0_12px_#ef4444] animate-pulse" />
                ),
              ...
              {
                icon: () => (
                  <Shield className="w-4 h-4 md:w-5 md:h-5 text-[#D4AF37] stroke-[1px]" />
                ),
              ...
              {
                icon: () => (
                  <Star className="w-4 h-4 md:w-5 md:h-5 text-[#D4AF37] stroke-[1px]" />
                ),
              ...
              >
                ...
                <div className="text-left">
                  <h3 className="font-bold text-white font-display tracking-wide uppercase text-[13px] md:text-[15px] text-center">
                    {item.title}
                  </h3>
      ...
      <Section className="overflow-hidden section-padding">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground">
            Des praticiens passionnés, multilingues et dévoués à votre santé
            bucco-dentaire
          </p>
        </div>
            ...
            {[...DOCTORS, ...DOCTORS].map((doc, idx) => (
              ...
              >
                <div className="h-[400px] p-2">
                  <img
                    src={doc.img}
                    alt={`${doc.name} - Dentiste à Port-de-Bouc`}
                    className="w-full h-full aspect-[3/4] object-cover rounded-[15px] shadow-sm"
                  />
                </div>
                <div className="p-6">
        ...
        <div className="text-center mt-12">
          <Button size="lg" onClick={() => setLocation("/equipe")}>
            Découvrez tout l'équipe (12 praticiens)
          </Button>
        </div>
      </Section>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center animate-fade-in-up">
          ...
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Au Centre Dentaire Easy Dent, nous croyons que chaque patient est
              unique. Notre approche combine une expertise médicale rigoureuse
              avec une écoute attentive de vos besoins.
            </p>
      ...
      <Section variant="muted" className="overflow-hidden section-padding">
        <div className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-lg text-muted-foreground">
            Plus de 180 avis positifs sur Google et autres plateformes
          </p>
        </div>
      ...
      <Section variant="dark" className="text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl mb-6 text-white font-display">
            Besoin d'un rendez-vous rapidement ?
          </h2>
          <p className="text-xl text-white/80 mb-8">
            Consultez nos disponibilités en ligne et réservez votre créneau en
            quelques clics.
          </p>

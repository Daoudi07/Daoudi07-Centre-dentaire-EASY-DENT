...
const TEAM_MEMBERS = [
  ...
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/pertuis/adriana-sahlean?pid=practice-131168",
  },
  {
  ...
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/marseille/melvyn-saadi-marseille?pid=practice-131168",
  },
  {
    name: "Dr Petra Hent",
    role: "Chirurgien-dentiste",
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/marseille/petra-hent-saint-ouen?pid=practice-131168",
  },
  {
    name: "Dr Ines Youcef",
    role: "Chirurgien-dentiste",
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/berre-l-etang/ines-youcef-port-de-bouc?pid=practice-131168",
  },
  {
    name: "Dr Elea Bondil",
    role: "Chirurgien-dentiste",
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/marseille/elea-bondil-4cfb7ce8-a247-408f-83c5-a837c7af9a6a?pid=practice-131168",
  },
  {
  ...
  },
  {
    ...
    doctolib:
      "https://www.doctolib.fr/dentiste/port-de-bouc/wacil-youcef?pid=practice-131168",
  },
];
...
export default function Team() {
  return (
    <Layout>
      <section
        className="section-hero relative h-[400px] flex items-center justify-center bg-cover bg-center"
        style={{ backgroundImage: `url(${stockTeamHero})` }}
      >
            ...
            >
              <div className="h-80 bg-muted flex items-center justify-center relative shrink-0 p-2">
                {member.img ? (
                  <img
                    src={member.img}
                    alt={`${member.name} - Dentiste à Port-de-Bouc`}
                    className="w-full h-full aspect-[3/4] object-cover rounded-[15px] shadow-sm group-hover:scale-105 transition-transform duration-500"
                  />
                ) : (
